...
const Menu = () => {
    return (
     <div className='dib br3 ba3 ma3 grow bw2 shadow-5 pl-10 fl br4'>       
<div className="wrapper">
      ...
      >
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align='left' valign='middle' class='consumers'>
                    <img alt='##'src="https://tinyfac.es/data/avatars/852EC6E1-347C-4187-9D42-DF264CCF17BF-200w.jpeg" />
                    <img alt='##'src="https://tinyfac.es/data/avatars/5F8C5D50-DDB6-4F06-AA15-ACB30D8D910D-200w.jpeg" />
                    <img alt='##'src="https://tinyfac.es/data/avatars/A7299C8E-CEFC-47D9-939A-3C8CA0EA4D13-200w.jpeg" />
                    <img alt='##'src="https://tinyfac.es/data/avatars/AEF44435-B547-4B84-A2AE-887DFAEE6DDF-200w.jpeg" />
                    <span>(+20)</span>
                  </td>
                </tr>
              </table>
            ...
            // {/* <div className= 'tc dib br3 ba3 ma3 grow bw2 shadow-5 pl-10 w-65  fl br4'>
            // <div className= 'col-mb-12 col-tb-6 col-lt-6 img'>
            //     <p>Main dish</p>
            //     <img alt='##' src={require('../src/img/image2.jpg')} />		
        	// </div>
                
            
            // <div className='tc dib br3 ba3 ma3 grow bw2 shadow-5 fl  br4'> 
            // <p>hfhsh hjdajgfhj ghKHG khgfdkhFSD ghdfjhgkj</p>
            // </div> */}
